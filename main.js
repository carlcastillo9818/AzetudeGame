...
class Game extends Phaser.Scene {
    constructor() {
        ...
        this.xVelocityBallPlayer = getRndInteger(700, 800);
        this.yVelocityBallPlayerList = [getRndInteger(0, 0), getRndInteger(-300, -400), getRndInteger(300, 400)];

        this.xVelocityBallEnemy = getRndInteger(-700, -800);
        this.yVelocityBallEnemyList = [getRndInteger(0, 0), getRndInteger(-300, -400), getRndInteger(300, 400)];
